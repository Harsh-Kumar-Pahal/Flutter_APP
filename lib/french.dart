...
class _audioState extends State<audio>{
  ...
  Widget build(BuildContext context){
    ...
    home: Scaffold(
      ...
      appBar: AppBar(title:  Text("FRENCH", style: TextStyle(fontSize: 30),), backgroundColor: Colors.lightBlue[900],),
              ...
              child:Container(
                child: Column(
                  ...
                  children:
                    ...
                    Text("FRENCH", style: TextStyle(fontSize:50, color: Colors.lightBlue[900])),

                    SizedBox(
                      height: 350,
                      width: 350,
                      child: neu_button(child: Image.asset("assets/tower.png"),),
                    ),
